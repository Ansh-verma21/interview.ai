    ...
    return(
        <Form {...form}>
            <form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
                <GeneratedAvatar seed={form.watch("name")} varient="botttsNeutral" className="border size-12"/>
                ...
                <FormField name="instructions" control={form.control} render={({field})=>(
                    <FormItem>
                        ...
                        <FormControl>
                            <Textarea {...field} placeholder="Eg- You are a helpful DSA interview Assistant that can help to prepare for DSA interviews."/>
                        </FormControl>
                        <FormMessage/>
                    </FormItem>
                )}/>
